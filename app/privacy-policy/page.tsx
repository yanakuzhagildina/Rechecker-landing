...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen">
      <Header />
      <main className="w-full px-6 md:px-12 lg:px-24 py-12 pt-28 md:pt-32">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Privacy Policy</h1>
          <p className="text-gray-600 mb-12">Last updated: August 01, 2025</p>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li><strong>Application</strong> refers to Rechecker, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Rechecker.</li>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-2">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
              <ul className="list-disc pl-6 space-y-1 text-gray-700">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                By email: <a href="mailto:capsmol@gmail.com" className="text-black underline hover:text-gray-700">capsmol@gmail.com</a>
              </p>
            </section>
          </div>
        </div>
